...
echo   1. PDF - Encabezado con nombre de archivo(s) y sobreescribirlos
echo.
set /p "RESP=Crear acceso directo en 'Enviar a' para el script de encabezado? (S/N): "
...
echo [OK] Acceso directo creado en 'Enviar a'.
